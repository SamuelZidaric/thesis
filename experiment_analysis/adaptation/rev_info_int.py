...
def perform_data_analysis(main_path):
    ...
    all_data = pd.DataFrame()  # Placeholder for the compiled DataFrame
    ...
    if not all_data.empty:
        # Predefined sequence of group values
        ...
        extended_subdivision_values = subdivision_values * (len(all_data) // len(subdivision_values) + 1)
